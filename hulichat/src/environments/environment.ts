...
export const environment = {
  production: false,
  firebase: {
    apiKey: 'AIzaSyAUUWIOEbpKraIjJBjEQqW5SHoid3Seqac',
    authDomain: 'mychat-ae48e.firebaseapp.com',
    databaseURL: 'https://mychat-ae48e.firebaseio.com',
    projectId: 'mychat-ae48e',
    storageBucket: '',
    messagingSenderId: '745908180231'
